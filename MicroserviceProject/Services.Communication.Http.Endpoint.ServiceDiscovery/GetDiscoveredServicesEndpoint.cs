...
{
    public class GetDiscoveredServicesEndpoint : IEndpoint
    {
        public static string Path => "servicediscoery.getdiscoveredservices";
        public string Url { get; set; } = "/Discovery/DiscoveredServices";
