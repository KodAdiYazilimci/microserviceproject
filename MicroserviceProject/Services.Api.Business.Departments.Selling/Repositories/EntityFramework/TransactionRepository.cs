...
namespace Services.Api.Business.Departments.Selling.Repositories.EntityFramework
{
    ...
    /// </summary>
    public class TransactionRepository : BaseRepository<SellingContext, RollbackEntity>, IAsyncDisposable
    {
        /// <summary>
        ...
        public TransactionRepository(SellingContext context) : base(context)
        {
            _context = context;
        }
