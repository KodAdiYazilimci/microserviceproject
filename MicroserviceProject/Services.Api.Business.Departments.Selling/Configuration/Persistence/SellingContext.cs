...
namespace Services.Api.Business.Departments.Selling.Configuration.Persistence
{
    public class SellingContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("server=sql-server;DataBase=Microservice_Selling_DB;user=sa;password=Srkn_CMR*1987;MultipleActiveResultSets=true;TrustServerCertificate=Yes");
