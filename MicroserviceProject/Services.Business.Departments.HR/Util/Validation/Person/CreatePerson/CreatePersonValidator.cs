...
using Services.Business.Departments.HR.Configuration.Validation.Person.CreatePerson;
...
namespace Services.Business.Departments.HR.Util.Validation.Person.CreatePerson
{
    /// <summary>
