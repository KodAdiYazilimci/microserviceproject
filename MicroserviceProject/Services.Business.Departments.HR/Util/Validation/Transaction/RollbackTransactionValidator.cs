...
using MicroserviceProject.Services.Business.Departments.HR.Configuration.Validation.Transaction;
...
namespace MicroserviceProject.Services.Business.Departments.HR.Util.Validation.Transaction
{
    /// <summary>
