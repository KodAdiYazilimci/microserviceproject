...
namespace Services.Business.Departments.HR.Services
{
    ...
    public class DepartmentService : BaseService, IRollbackableAsync<int>, IDisposable, IDisposableInjections
    {
        ...
        /// </summary>
        public override string ServiceName => "Services.Business.Departments.HR.Services.DepartmentService";
        ...
        /// </summary>
        private const string CACHED_DEPARTMENTS_KEY = "Services.Business.Departments.HR.Departments";
