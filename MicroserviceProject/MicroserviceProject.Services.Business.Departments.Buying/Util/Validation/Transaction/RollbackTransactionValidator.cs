...
using MicroserviceProject.Services.Business.Departments.Buying.Configuration.Validation.Transaction;
...
namespace MicroserviceProject.Services.Business.Departments.Buying.Util.Validation.Transaction
{
    /// <summary>
