...
namespace Services.Api.Business.Departments.AA.Services
{
    /// <summary>
    ...
    public class InventoryService : BaseService, IRollbackableAsync<int>, IDisposable, IDisposableInjections
    {
        ...
        /// </summary>
        public override string ServiceName => "Services.Api.Business.Departments.AA.Services.InventoryService";

        /// <summary>
        /// Servisin ait olduğu api servisinin adı
        /// </summary>
        public override string ApiServiceName => "Services.Api.Business.Departments.AA";

        /// <summary>
        /// Önbelleğe alınan envanterlerin önbellekteki adı
        /// </summary>
        private const string CACHED_INVENTORIES_KEY = "Services.Api.Business.Departments.AA.Inventories";

        /// <summary>
        /// Önbelleğe alınan varsayılan envanterlerin önbellekteki adı
        /// </summary>
        private const string CACHED_INVENTORIES_DEFAULTS_KEY = "Services.Api.Business.Departments.AA.InventoryDefaults";
