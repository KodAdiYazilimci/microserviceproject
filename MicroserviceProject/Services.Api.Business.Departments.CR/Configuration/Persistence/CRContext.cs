...
namespace Services.Api.Business.Departments.CR.Configuration.Persistence
{
    public class CRContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("server=sql-server;DataBase=Microservice_CR_DB;user=sa;password=Srkn_CMR*1987;MultipleActiveResultSets=true;TrustServerCertificate=Yes");
