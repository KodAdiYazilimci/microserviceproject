    ...
    public class ConfigurationFactory
    {
        public static IConfiguration GetConfiguration()
        {
            ...
            return Configuration.GetConfiguration(
                ...
                loggingAbsoluteFilePath: "C:\\Logs\\Services.Api.Business.Departments.IT\\",
                loggingRelativeFilePath: "RequestResponseLogs/",
                databaseSections: new List<AnyDatabaseSection>()
                {
                    new AnyDatabaseSection("Microservice_IT_DB","server=localhost;DataBase=Microservice_IT_DB;user=sa;password=Srkn_CMR*1987;MultipleActiveResultSets=true;TrustServerCertificate=Yes")
                });
        }
    }
}
