...
namespace Services.Business.Departments.Storage.Repositories.EntityFramework
{
    /// <summary>
    /// Müşteri ilişkileri işlem öğeleri tablosu için repository sınıfı
    /// </summary>
    public class TransactionRepository : BaseRepository<StorageContext, RollbackEntity>, IAsyncDisposable
    {
        /// <summary>
        ...
        public TransactionRepository(StorageContext context) : base(context)
        {
            _context = context;
        }
