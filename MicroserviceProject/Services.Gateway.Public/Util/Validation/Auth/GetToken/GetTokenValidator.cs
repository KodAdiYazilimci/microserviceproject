...
using MicroserviceProject.Services.Gateway.Public.Validation.Auth.GetToken;
...
namespace MicroserviceProject.Services.Gateway.Public.Util.Validation.Auth.GetToken
{
    /// <summary>
