...
using Services.Business.Departments.AA.Configuration.Validation.Inventory.AssignInventoryToWorker;
...
namespace Services.Business.Departments.AA.Util.Validation.Inventory.AssignInventoryToWorker
{
    /// <summary>
