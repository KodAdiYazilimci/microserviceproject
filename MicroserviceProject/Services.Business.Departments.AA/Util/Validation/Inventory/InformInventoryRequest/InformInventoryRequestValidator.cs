...
using Services.Business.Departments.AA.Configuration.Validation.Inventory.InformInventoryRequest;
...
namespace Services.Business.Departments.AA.Util.Validation.Inventory.InformInventoryRequest
{
    /// <summary>
