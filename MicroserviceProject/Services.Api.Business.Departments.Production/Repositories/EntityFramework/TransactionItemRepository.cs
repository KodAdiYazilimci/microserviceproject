...
namespace Services.Api.Business.Departments.Production.Repositories.EntityFramework
{
    ...
    /// </summary>
    public class TransactionItemRepository : BaseRepository<ProductionContext, RollbackItemEntity>, IAsyncDisposable
    {
        /// <summary>
        ...
        public TransactionItemRepository(ProductionContext context) : base(context)
        {
            _context = context;
        }      
