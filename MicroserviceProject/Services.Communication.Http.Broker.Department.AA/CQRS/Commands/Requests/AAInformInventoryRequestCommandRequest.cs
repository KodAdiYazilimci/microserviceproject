...
{
    public class AAInformInventoryRequestCommandRequest : IRequest<AAInformInventoryRequestCommandResponse>
    {
        public AAInventoryRequestModel InventoryRequest { get; set; }
    }
}
