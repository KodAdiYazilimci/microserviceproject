    ...
    public class ConfigurationFactory
    {
        public static IConfiguration GetConfiguration()
        {
            ...
            return Configuration.GetConfiguration(
                ...
                loggingAbsoluteFilePath: "C:\\Logs\\Services.Api.Business.Departments.AA\\",
                loggingRelativeFilePath: "RequestResponseLogs/",
                databaseSections: new List<AnyDatabaseSection>()
                {
                    new AnyDatabaseSection("Microservice_AA_DB","server=localhost;DataBase=Microservice_AA_DB;user=sa;password=Srkn_CMR*1987;MultipleActiveResultSets=true;TrustServerCertificate=Yes")
                });
        }
    }
}
