...
using Services.Business.Departments.Buying.Configuration.Validation.Transaction;
...
namespace Services.Business.Departments.Buying.Util.Validation.Transaction
{
    /// <summary>
