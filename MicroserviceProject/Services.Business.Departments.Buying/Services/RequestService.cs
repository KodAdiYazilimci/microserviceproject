...
namespace MicroserviceProject.Services.Business.Departments.Buying.Services
{
    ...
    public class RequestService : BaseService, IRollbackableAsync<int>, IDisposable, IDisposableInjections
    {
        ...
        public async Task<List<InventoryRequestModel>> GetInventoryRequestsAsync(CancellationTokenSource cancellationTokenSource)
        {
            ...
            List<MicroserviceProject.Infrastructure.Communication.Model.Department.AA.InventoryModel> aaInventories = new List<MicroserviceProject.Infrastructure.Communication.Model.Department.AA.InventoryModel>();

            if (mappedInventoryRequests.Any(x => x.DepartmentId == (int)MicroserviceProject.Infrastructure.Communication.Model.Department.Constants.Departments.AdministrativeAffairs))
            {
                aaInventories = await GetAAInventoriesAsync(cancellationTokenSource);
            }

            List<MicroserviceProject.Infrastructure.Communication.Model.Department.IT.InventoryModel> itInventories = 
                new List<MicroserviceProject.Infrastructure.Communication.Model.Department.IT.InventoryModel>();
            ...
            {
                if (requestModel.DepartmentId == (int)MicroserviceProject.Infrastructure.Communication.Model.Department.Constants.Departments.AdministrativeAffairs)
                {
                    requestModel.AAInventory = aaInventories.FirstOrDefault(x => x.Id == requestModel.InventoryId);
                }
                else if (requestModel.DepartmentId == (int)MicroserviceProject.Infrastructure.Communication.Model.Department.Constants.Departments.InformationTechnologies)
                {
        ...
        /// <returns></returns>
        private async Task<List<MicroserviceProject.Infrastructure.Communication.Model.Department.AA.InventoryModel>> GetAAInventoriesAsync(CancellationTokenSource cancellationTokenSource)
        {
            ServiceResultModel<List<MicroserviceProject.Infrastructure.Communication.Model.Department.AA.InventoryModel>> serviceResult =
                    await
                    _serviceCommunicator.Call<List<MicroserviceProject.Infrastructure.Communication.Model.Department.AA.InventoryModel>>(
        ...
        /// <param name="cancellationTokenSource"></param>
        /// <returns></returns>
        private async Task<List<MicroserviceProject.Infrastructure.Communication.Model.Department.IT.InventoryModel>> GetITInventoriesAsync(CancellationTokenSource cancellationTokenSource)
        {
            ServiceResultModel<List<MicroserviceProject.Infrastructure.Communication.Model.Department.IT.InventoryModel>> serviceResult =
                    await
                    _serviceCommunicator.Call<List<MicroserviceProject.Infrastructure.Communication.Model.Department.IT.InventoryModel>>(
        ...
        public async Task<int> CreateInventoryRequestAsync(InventoryRequestModel inventoryRequest, CancellationTokenSource cancellationTokenSource)
        {
            ...
            if (mappedInventoryRequest.DepartmentId == (int)MicroserviceProject.Infrastructure.Communication.Model.Department.Constants.Departments.AdministrativeAffairs)
            {
                List<MicroserviceProject.Infrastructure.Communication.Model.Department.AA.InventoryModel> aaInventories = await GetAAInventoriesAsync(cancellationTokenSource);
            ...
            else if (mappedInventoryRequest.DepartmentId == (int)MicroserviceProject.Infrastructure.Communication.Model.Department.Constants.Departments.InformationTechnologies)
            {
                List<MicroserviceProject.Infrastructure.Communication.Model.Department.IT.InventoryModel> itInventories = await GetITInventoriesAsync(cancellationTokenSource);
        ...
        public async Task<int> ValidateCostInventoryAsync(DecidedCostModel decidedCost, CancellationTokenSource cancellationTokenSource)
        {
            ...
            if (inventoryRequestEntity.DepartmentId == (int)MicroserviceProject.Infrastructure.Communication.Model.Department.Constants.Departments.AdministrativeAffairs)
            {
            ...
            else if (inventoryRequestEntity.DepartmentId == (int)MicroserviceProject.Infrastructure.Communication.Model.Department.Constants.Departments.InformationTechnologies)
            {
