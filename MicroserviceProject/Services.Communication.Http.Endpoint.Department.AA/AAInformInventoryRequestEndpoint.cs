...
{
    public class AAInformInventoryRequestEndpoint : IEndpoint
    {
        public string Url { get; set; } = "/Inventory/InformInventoryRequest";
        public string Name { get; set; } = "aa.inventory.informinventoryrequest";
