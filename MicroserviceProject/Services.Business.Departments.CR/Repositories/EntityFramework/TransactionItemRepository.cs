...
namespace Services.Business.Departments.CR.Repositories.EntityFramework
{
    /// <summary>
    /// Müşteri ilişkileri işlem tablosu için repository sınıfı
    /// </summary>
    public class TransactionItemRepository : BaseRepository<CRContext, RollbackItemEntity>, IAsyncDisposable
    {
        /// <summary>
        ...
        public TransactionItemRepository(CRContext context) : base(context)
        {
            _context = context;
        }      
