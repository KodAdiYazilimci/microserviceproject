...
namespace Services.Business.Departments.Accounting
{
    ...
    public class Middleware
    {
            ...
            httpContext.Response.OnCompleted(async () =>
            {
                ...
                try
                {
                    ...
                    requestResponseLogger.LogAsync(
                        ...
                        {
                            ApplicationName = "Services.Business.Departments.Accounting",
                            Content = response,
                            Date = DateTime.Now,
        ...
        private static void SetServiceDefaults(HttpContext httpContext, IServiceProvider serviceProvider)
        {
            ...
            {
                var bankService = serviceProvider.GetService(typeof(BankService));
                (bankService as BankService).TransactionIdentity = httpContext.Request.Headers["TransactionIdentity"].ToString();
            }
        }
    }
