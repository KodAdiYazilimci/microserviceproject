...
using Services.Business.Departments.Accounting.Configuration.Validation.Transaction;
...
namespace Services.Business.Departments.Accounting.Util.Validation.Transaction
{
    /// <summary>
