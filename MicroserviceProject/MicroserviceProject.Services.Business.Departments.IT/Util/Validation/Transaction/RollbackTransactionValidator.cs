...
using MicroserviceProject.Services.Business.Departments.IT.Configuration.Validation.Transaction;
...
namespace MicroserviceProject.Services.Business.Departments.IT.Util.Validation.Transaction
{
    /// <summary>
