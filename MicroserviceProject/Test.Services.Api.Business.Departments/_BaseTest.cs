...
namespace Test.Services.Api.Business.Departments
{
    public class BaseTest
    {
        ...
        public BaseTest(InventoryControllerTest inventoryControllerTest,
        ...
        protected async Task<List<global::Services.Communication.Http.Broker.Department.AA.Models.InventoryModel>> GetAAInventoriesAsync()
        {
        ...
        protected async Task<ServiceResultModel> CreateAAInventoryAsync()
        {
        ...
        protected async Task<List<DepartmentModel>> GetAADepartmentsAsync()
        {
        ...
        protected async Task<List<WorkerModel>> GetWorkersAsync()
        {
        ...
        protected async Task<ServiceResultModel> CreateBankAccountToWorker(int workerId)
        {
        ...
        protected async Task<ServiceResultModel> CreateSalaryPaymentToWorker(int workerId)
        {
        ...
        protected async Task<List<PersonModel>> GetPeopleAsync()
        {
            var people = await personControllerTest.GetPeopleAsync();
