...
namespace Services.Business.Departments.Selling
{
    ...
    public class Middleware
    {
            ...
            httpContext.Response.OnCompleted(async () =>
            {
                ...
                try
                {
                    await requestResponseLogger.LogAsync(
                          ...
                          {
                              ApplicationName = "Services.Business.Departments.Selling",
                              Content = response,
                              Date = DateTime.Now,
        ...
        private static void SetServiceDefaults(HttpContext httpContext, IServiceProvider serviceProvider)
        {
            ...
            {
                var sellingService = serviceProvider.GetService(typeof(SellingService));
                (sellingService as SellingService).TransactionIdentity = httpContext.Request.Headers["TransactionIdentity"].ToString();
            }
        }
    }
