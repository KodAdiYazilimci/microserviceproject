...
using MicroserviceProject.Services.Business.Departments.Finance.Configuration.Validation.Transaction;
...
namespace MicroserviceProject.Services.Business.Departments.Finance.Util.Validation.Transaction
{
    /// <summary>
