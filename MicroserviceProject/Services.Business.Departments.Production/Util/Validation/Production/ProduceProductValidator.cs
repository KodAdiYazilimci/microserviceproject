...
using Services.Business.Departments.Production.Configuration.Validation.Production;
...
namespace Services.Business.Departments.Production.Util.Validation.Production
{
    /// <summary>
