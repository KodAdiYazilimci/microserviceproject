...
namespace Services.Business.Departments.Production.Repositories.EntityFramework
{
    ...
    /// </summary>
    public class TransactionRepository : BaseRepository<ProductionContext, RollbackEntity>, IAsyncDisposable
    {
        /// <summary>
        ...
        public TransactionRepository(ProductionContext context) : base(context)
        {
            _context = context;
        }
