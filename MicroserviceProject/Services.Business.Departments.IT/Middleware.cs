...
namespace Services.Business.Departments.IT
{
    ...
    public class Middleware
    {
            ...
            httpContext.Response.OnCompleted(async () =>
            {
                ...
                try
                {
                    ...
                    requestResponseLogger.LogAsync(
                        ...
                        {
                            ApplicationName = "Services.Business.Departments.IT",
                            Content = response,
                            Date = DateTime.Now,
        ...
        private static void SetServiceDefaults(HttpContext httpContext, IServiceProvider serviceProvider)
        {
            ...
            {
                var inventoryService = serviceProvider.GetService(typeof(InventoryService));
