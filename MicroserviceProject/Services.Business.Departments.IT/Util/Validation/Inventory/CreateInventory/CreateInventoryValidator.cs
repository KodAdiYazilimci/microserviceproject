...
using Services.Business.Departments.IT.Configuration.Validation.Inventory.CreateInventory;
...
namespace Services.Business.Departments.IT.Util.Validation.Inventory.CreateInventory
{
    /// <summary>
