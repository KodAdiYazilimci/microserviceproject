...
namespace MicroserviceProject.Services.Business.Departments.HR.Repositories.Sql
{
    ...
    /// </summary>
    public class PersonRepository : BaseRepository, IDisposable
    {
        /// <summary>
        ...
        /// <returns></returns>
        public async Task<List<PersonEntity>> GetPeopleAsync(CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">İptal tokenı</param>
        /// <returns></returns>
        public async Task<int> CreatePersonAsync(PersonEntity person, CancellationToken cancellationToken)
        {
